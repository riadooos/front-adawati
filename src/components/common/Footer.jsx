...
import LogoAdawati from "../assets/images/logo-adawati.png";
    ...
    <>
      ...
      <footer className="bg-[#F3F4F8] py-10 pt-32 -mt-24">
        <div className="container grid grid-cols-4 gap-5 md:grid-cols-2">
          <div className="logo">
            <img src={LogoAdawati} alt="LogoAdawati" className="h-10" />
            <span className="text-[14px]">
              Les fournitures scolaires de bonne qualité jouent un rôle crucial
              dans la réussite de vos enfant. En choisissant nos produits vos
              mettez vos enfant dans les meilleurs conditions pour un
              apprentisage sein et aggréable
            </span>
          </div>

          <li>
            <h4 className="text-black text-sm font-semibold mb-5">Adawati</h4>
          ...
          <li>
            <h4 className="text-black text-sm font-semibold mb-5">Ecole</h4>
            <NavLink to="#" className=" text-[14px] block mb-2">
              Recherche d'une ecole pour vos enfants
            </NavLink>
            <NavLink to="#" className=" text-[14px] block mb-2">
              Contact Ecole
            </NavLink>
            <NavLink to="#" className=" text-[14px] block mb-2">
              Commentaires sur Prestations
            </NavLink>
            <NavLink to="#" className=" text-[14px] block mb-2">
              Services
            </NavLink>
